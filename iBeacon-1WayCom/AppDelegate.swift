...
//  iBeacon-alpha3
//
//  Created by Eric Theis on 6/13/14.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    //var myChannel: PNChannel = PNChannel.channelWithName("bot", shouldObservePresence: true) as PNChannel
    ...
    func pubnubClient(client: PubNub!, didSubscribeOnChannels channels: NSArray!){
        println("DELEGATE: Subscribed to channel: \(channels)")
    }
